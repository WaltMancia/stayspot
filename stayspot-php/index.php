...
if (str_starts_with($uri, '/api')) {
    ...
    match (true) {
        $method === 'GET' && $uri === '/api/spaces' => responder(200, $espacios),
        $method === 'GET' && preg_match('/^\/api\/spaces\/(\d+)$/', $uri, $m) => manejarEspacioIndividual((int) $m[1], $espacios),
        $method === 'POST' && $uri === '/api/spaces' => crearEspacio(),
        default => responder(404, ['error' => 'Ruta no encontrada']),
    };
}
...
<body class="bg-gray-50 min-h-screen">
    ...
    <script src="/stayspot-vue-puro/js/components/SpaceCard.js"></script>
    <script src="/stayspot-vue-puro/js/components/SearchBar.js"></script>
    <script src="/stayspot-vue-puro/js/components/ReservationModal.js"></script>
    <script src="/stayspot-vue-puro/js/App.js"></script>
